...
final class BuildConfigurationTests: XCTestCase {
    ...
    func testAppIconContractIsDiscoverableByFutureAgents() throws {
        ...
        XCTAssertTrue(contract.contains("original filled rec.me locator"))
        XCTAssertTrue(contract.contains("not an SF Symbol"))
        ...
        XCTAssertTrue(masterGeneratorSource.contains("drawOriginalLocator"))
        XCTAssertFalse(masterGeneratorSource.contains("systemSymbolName"))
