...
final class NavigationContractTests: XCTestCase {
    ...
    func testMapPlaceCardUsesPhotoBackedRoundedSurfaceWhileHistoryKeepsTickets() throws {
        ...
        XCTAssertTrue(previewCard.contains("PlaceCardPressStyle()"))
        XCTAssertTrue(previewCard.contains("PlaceCardPhotoAttribution(photo: photo)"))
        ...
        XCTAssertTrue(previewCard.contains("scaleEffect(configuration.isPressed && !reduceMotion ? 1.6 : 1)"))
