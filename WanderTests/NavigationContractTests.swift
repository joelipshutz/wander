...
final class NavigationContractTests: XCTestCase {
    ...
    func testMapPlaceCardUsesPhotoBackedRoundedSurfaceWhileHistoryKeepsTickets() throws {
        ...
        XCTAssertTrue(previewCard.contains("GlassEffectContainer(spacing: 6)"))
        XCTAssertTrue(previewCard.contains("VStack(spacing: 8)"))
        ...
        XCTAssertTrue(previewCard.contains("scaleEffect(configuration.isPressed && !reduceMotion ? 1.4 : 1)"))
