...
test("MapKit geography mirror preserves production LA, Georgia, and DC semantics", {
  ...
  try {
    const actual = await inspectMapKitGeography([
      ...
      { id: "california-abbreviation", area: "CA" },
      { id: "laos-country", area: "Laos" },
      { id: "canada-country", area: "Canada" },
      { id: "us-country-alias", area: "USA" },
    ...
    assert.deepEqual(actual, [
      ...
      { id: "california-abbreviation", stateCode: "CA", hasSearchRegion: true },
      { id: "laos-country", hasSearchRegion: false, localityText: "Laos", interpretedCountryCode: "LA" },
      { id: "canada-country", hasSearchRegion: false, localityText: "Canada", interpretedCountryCode: "CA" },
      { id: "us-country-alias", hasSearchRegion: false, localityText: "USA", interpretedCountryCode: "US" },
      { id: "georgia-country-ambiguous", hasSearchRegion: false, localityText: "Georgia", interpretedCountryCode: "GE" },
