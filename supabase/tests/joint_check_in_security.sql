...
select is((select count(*) from pg_proc p join pg_namespace n on n.oid=p.pronamespace
 ...
 'set_activity_like_v2','set_activity_comment_like_v2','add_activity_comment_v2','activity_comments_v2','list_shared_visit_inbox_v2',
 'get_shared_visit_context_v2','resolve_shared_visit_destination_v2'])),20::bigint,'all twenty v2 RPCs exist');
select ok(not exists(select 1 from pg_proc p join pg_namespace n on n.oid=p.pronamespace
 where n.nspname='public' and p.proname=any(array['save_joint_check_in','edit_joint_check_in','accept_joint_check_in','save_joint_invitation_privately','set_joint_check_in_invitees','leave_joint_check_in','decline_joint_check_in','joint_check_in_contexts','followed_feed_v2','activity_detail_v2','activity_media_v2','activity_engagement_summaries_v2','place_activity_engagement_summaries_v2','set_activity_like_v2','set_activity_comment_like_v2','add_activity_comment_v2','activity_comments_v2','list_shared_visit_inbox_v2','get_shared_visit_context_v2','resolve_shared_visit_destination_v2'])
