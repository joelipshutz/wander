...
where owner_user_id is null
  and question_key = 'interest_signal';
...
where entity_name in ('places', 'user_places', 'place_attributes', 'source_artifacts', 'extraction_jobs');
...
where not exists (
  ...
  and not exists (
    ...
    where ej.selected_place_id = p.id
  );
