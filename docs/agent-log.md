...
- Committed the review as `c409af9` (`docs: design adaptive list photo covers`), pushed `codex/rec-93-list-place-photos`, and opened draft PR #98: https://github.com/joelipshutz/wander/pull/98. The PR remains draft until Joe confirms the one product decision above; no merge or release was requested.
