...
options. Check-in keeps it inside More options. List selection remains optional
and is available for first saves, repeat saves, and edits. Lists already containing
the canonical place are disabled and labeled **Already in list**; repeat visits
never create duplicate entries for that place in a list.
