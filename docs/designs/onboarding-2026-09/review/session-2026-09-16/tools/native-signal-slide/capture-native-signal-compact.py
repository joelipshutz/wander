...
root=Path('/Users/joelipshutz/Documents/ChatGPT/New project/onboarding-copy-review/session-2026-09-16');sys.path.insert(0,str(root));import capture_native as c
...
for mode in ['dark','light']:
 ...
 for screen in ['W00','W01','W02']:
  ...
  path=root/'native-captures/signal-slide'/f'signal-{mode}-{screen}-compact.png'
...
(root/'native-captures/signal-slide/compact-checks.json').write_text(json.dumps(checks,indent=2)+'\n')
c.run('shutdown',sim)
