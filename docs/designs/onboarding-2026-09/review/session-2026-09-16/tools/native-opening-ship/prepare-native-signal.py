...
root=Path('/Users/joelipshutz/Documents/ChatGPT/New project/onboarding-copy-review/session-2026-09-16');media=root/'native-captures/signal-slide-final'
meta={'sourceCommit':subprocess.check_output(['git','-C',str(root.parent.parent/'wander-native-onboarding-review'),'rev-parse','4cba092'],text=True).strip(),'native':True,'higgsfieldGenerationUsed':False,'motionRevision':'signal-slide-v2','font':'AvenirNext-Bold','leadFont':'native editorial serif semibold, 0.108 × content width; word 0.104 × width','sceneSlideSeconds':1.5,'initialEntranceSeconds':1.5,'openingSeconds':17.1,'wordHoldSeconds':1.8,'activeFlapHaptics':False,'finishes':[]}
...
for mode in ['dark','light']:
 ...
 phases={'community':2.0,'wordChange':2.95,'wordPlaces':8.4,'finalChange':12.8,'final':15.8,'sceneChange':17.5,'places':22.5,'peopleChange':26.3,'people':31.5}
 proof={};shots=[]
