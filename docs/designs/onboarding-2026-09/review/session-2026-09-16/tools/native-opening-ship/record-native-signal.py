...
sys.path.insert(0,str(root));import capture_opening_ship as c
...
out=root/'native-captures/signal-slide-final';out.mkdir(exist_ok=True);log=json.loads((out/'recording-checks.json').read_text()) if (out/'recording-checks.json').exists() else []
