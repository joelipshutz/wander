...
- [Original numbered screens and native screenshots](http://127.0.0.1:8766/) — the build-174 baseline discussed in the recording. Its historical “Active” labels describe that baseline, not approval for the redesigned journey.
- [Current native Map review: M01](http://127.0.0.1:8766/session-2026-09-16/?screen=M01&present=1) — M01–M06, N25 and C01–C04 are the existing replacement IDs.
- [Transcript-backed interpretation](http://127.0.0.1:8766/session-2026-09-16/brief/nux-transcript-spec.html) — the previous NUX specification, with quotations and unresolved choices.
- [T05: Map, motion, navigation and Feed](../transcripts/T05.txt). Search anchors: “super quick level overview,” “put the next in the top right,” “N14 is gone,” and “forced feed pass.”
- [T04: finale, Lists, annotations and return visits](../transcripts/T04.txt). Search anchors: “N25,” “nearby places section,” “place profile itself,” “kill twenty six,” and “looking at 28.”
- [Task ledger](../TASKS.md), especially **OB17–OB30**; [decision audit](../transcript-audit.md), **A36–A65**; [permission and Map evidence](../permission-and-map-evidence.md).
...
|---|---|---|
| N13 | [Saving a place](../../screenshots/mapAdd.png) | Fold the brief + explanation into M05. |
| N14 | [Finding a park near you](../../screenshots/addSearch.png) | Remove the forced search demonstration; N14 is explicitly named for removal in T05. |
| N15 | [Have you been here before?](../../screenshots/saveStatus.png) | Explain the distinction briefly in M06 and on the actual place actions in C04. |
| N16 | [A date makes it a memory](../../screenshots/saveDate.png) | Retire the forced date-field lesson. |
| N17 | [Leave a note for future you](../../screenshots/saveNote.png) | Retire the forced note lesson. |
| N18 | [A rating helps future you](../../screenshots/saveRating.png) | Retire the forced rating lesson. |
| N19 | [Add the detail you’ll remember](../../screenshots/saveMoreOptions.png) | Retire the forced More Options lesson. |
| N20 | [Why this place fits](../../screenshots/saveQuestions.png) | Retire the forced questions lesson. |
| N21 | [Tag it for later](../../screenshots/saveTags.png) | Retire the forced tags lesson. |
| N22 | [Ready to save](../../screenshots/saveSubmit.png) | Remove the required tutorial save. |
| N23 | [One more shortcut](../../screenshots/mapAddAgain.png) | Remove the second forced + visit. |
| N24 | [Bring saves with you](../../screenshots/addImport.png) | Mention imports in M05 without opening or requiring the import flow. |
| N26 | [Return visit · Import](../../screenshots/import-lesson.png) | Retire the scheduled later-launch import lesson. T04: “we'll kill twenty six.” |
